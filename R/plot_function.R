#' @description Plots the relationship between two variables in the starwars dataset, showcasing the potential correlations or distributions.
#' @title Plot of the Relationship
#' @param x: a numeric variable
#' @param y: a numeric variable
#' @return Return a plot of the relationship between x and y
#' @examples
